...
Sou Desenvolvedor Full Stack com foco na construção de softwares confiáveis, serviços backend, integrações entre sistemas, automações e soluções em cloud.

Minha experiência envolve desenvolvimento frontend e backend, APIs, bancos de dados, automação, infraestrutura e sistemas legados. Trabalho principalmente com Python, COBOL, TypeScript, JavaScript, Node.js, Next.js, FastAPI, NestJS, PostgreSQL, Docker e AWS, entre outras tecnologias.

Tenho especial interesse em arquitetura de software, integração de sistemas, automação, engenharia backend e na conexão entre aplicações modernas e ambientes legados.
